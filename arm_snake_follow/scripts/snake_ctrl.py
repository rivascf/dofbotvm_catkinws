...
class snake_ctrl:
        ...
        try:
            ...
            if isinstance(response, kinemaricsResponse):
                ...
                if 0.22 < response.z < 0.23 and response.y > 0 and -1.6 < response.Roll < -1.5:
                    ...
                    move_joint2 = [90, joints[1], joints[2], joints[3], 0, 0]
                    if self.move_num == 1:
    ...
    def snake_main(self, name, msg,joint_target):

        s1, s2, s3, s4, s5 = joint_target[0], joint_target[1], joint_target[2], joint_target[3], joint_target[4]
